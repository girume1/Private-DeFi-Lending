...
const ZKBadge: React.FC = () => (
  <div style={{
    ...
    <span style={{
      fontSize: '0.78rem', fontFamily: "'Orbitron', monospace",
...
// ─── Stat counter ─────────────────────────────────────────────────────────────
const StatCard: React.FC<{ value: string; label: string; color: string; delay: string }> = ({ value, label, color, delay }) => (
  <div style={{ textAlign: 'center', animation: `fadeUp 0.7s ease ${delay} both` }}>
    <div style={{
    ...
    <div style={{ fontSize: '0.78rem', color: 'rgba(248,250,252,0.5)', marginTop: '4px', letterSpacing: '0.05em', fontFamily: "'Exo 2', sans-serif" }}>
      {label}
    </div>
  </div>
);
...
const FeatureCard: React.FC<{
  ...
  <div style={{
    ...
    onMouseEnter={e => {
      ...
      (e.currentTarget as HTMLDivElement).style.boxShadow = `0 20px 40px ${color}15`;
    }}
    onMouseLeave={e => {
  ...
  >
    ...
    <div style={{ fontFamily: "'Orbitron', sans-serif", fontSize: '1rem', fontWeight: 700, color: '#F8FAFC', marginBottom: '8px', letterSpacing: '-0.01em' }}>{title}</div>
    <div style={{ fontSize: '0.875rem', color: 'rgba(248,250,252,0.65)', lineHeight: 1.65, fontFamily: "'Exo 2', sans-serif" }}>{desc}</div>
  </div>
);

// ─── How it works step ────────────────────────────────────────────────────────
const Step: React.FC<{ num: string; title: string; desc: string; color: string; delay: string }> = ({ num, title, desc, color, delay }) => (
  <div style={{
    ...
    <div>
      <div style={{ fontFamily: "'Orbitron', sans-serif", fontWeight: 700, color: '#F8FAFC', marginBottom: '4px', fontSize: '0.9rem' }}>
        {title}
      </div>
      <div style={{ fontSize: '0.875rem', color: 'rgba(248,250,252,0.65)', lineHeight: 1.6, fontFamily: "'Exo 2', sans-serif" }}>
        {desc}
      </div>
    </div>
  </div>
...
const LoanDiagram: React.FC = () => (
  <div style={{
    ...
    <div style={{
      ...
      color: '#0F172A', fontWeight: 700, letterSpacing: '0.08em',
      boxShadow: '0 4px 20px rgba(245,158,11,0.45)',
      whiteSpace: 'nowrap',
    }}>ZK PROOF VERIFIED</div>

    {/* Parties */}
    {[
      { label: 'BORROWER', icon: '👤', color: '#6366f1', sub: 'Private CreditTier' },
      { label: 'PROTOCOL', icon: '🔒', color: '#8b5cf6', sub: 'privlend_v5.aleo' },
      ...
      <div key={i} style={{ marginBottom: i < 2 ? '12px' : 0 }}>
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: "'Orbitron', sans-serif", fontSize: '0.7rem', color: p.color, fontWeight: 700, letterSpacing: '0.08em' }}>{p.label}</div>
            <div style={{ fontSize: '0.72rem', color: 'rgba(248,250,252,0.5)', marginTop: '2px', fontFamily: "'Exo 2', sans-serif" }}>{p.sub}</div>
          </div>
          <div style={{
        ...
        {i < 2 && (
          <div style={{
            marginLeft: '22px', width: 2, height: '12px',
    ...
    <div style={{
      ...
      <span style={{ fontSize: '0.72rem', color: 'rgba(148,163,184,0.6)', fontFamily: "'Space Mono', monospace" }}>COLLATERAL LOCKED</span>
      <span style={{ fontSize: '0.8rem', color: '#f59e0b', fontWeight: 700, fontFamily: "'Space Mono', monospace" }}>150% · CREDITS</span>
    </div>
  </div>
);
      ...
      <div style={{
        ...
        <nav style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #F59E0B, #8B5CF6)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '1rem', boxShadow: '0 4px 14px rgba(245,158,11,0.45)',
            }}>🔒</div>
            <span style={{
              fontFamily: "'Orbitron', sans-serif",
          ...
          <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
            {['Features', 'How it Works', 'Markets'].map(link => (
              <a key={link}
                ...
                style={{
                  fontSize: '0.875rem', color: 'rgba(248,250,252,0.6)',
        ...
        <section style={{
          ...
          <p style={{
            ...
            color: 'rgba(148,163,184,0.85)', maxWidth: '580px',
            lineHeight: 1.75, marginBottom: '44px',
            animation: 'fadeUp 0.8s ease 0.2s both',
          }}>
            Private  DeFi lending protocol on Aleo.
            Prove your creditworthiness with ZK proofs.
            Your identity, your collateral, your terms — all confidential.
          </p>
          ...
          <div style={{
            ...
            <button className="cta-btn" onClick={handleLaunch} style={{ fontSize: '1rem' }}>
          ...
          <div style={{
            ...
            <StatCard value="100%" label="Private Records"  color="#F59E0B" delay="0.4s" />
            <StatCard value="ZK"    label="Proof Verified"   color="#8B5CF6" delay="0.5s" />
            <StatCard value="150%"  label="Collateral Ratio" color="#10b981" delay="0.6s" />
            <StatCard value="3"     label="Credit Tiers"     color="#FBBF24" delay="0.7s" />
          </div>
        </section>
        ...
        <section id="features" style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
            <div style={{
              ...
              color: '#FBBF24', letterSpacing: '0.1em', marginBottom: '16px',
            }}>FEATURES</div>
            <h2 style={{
          ...
          <div style={{
            ...
            <FeatureCard delay="0s"   color="#6366f1" icon="🔐"
            ...
            <FeatureCard delay="0.1s" color="#8b5cf6" icon="🛡️"
            ...
            <FeatureCard delay="0.4s" color="#06b6d4" icon="🏛️"
            ...
            <FeatureCard delay="0.5s" color="#ec4899" icon="📊"
          ...
          <div style={{
            ...
            <div>
              <div style={{
                ...
                fontSize: '0.72rem', fontFamily: "'Orbitron', sans-serif",
                color: '#A78BFA', letterSpacing: '0.1em', marginBottom: '24px',
              }}>HOW IT WORKS</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                <Step delay="0.1s" num="01" color="#6366f1"
                ...
                <Step delay="0.2s" num="02" color="#8b5cf6"
                ...
                <Step delay="0.3s" num="03" color="#10b981"
                ...
                <Step delay="0.4s" num="04" color="#f59e0b"
                  title="Repay & Reclaim"
          ...
          <div style={{
            ...
            <div>
              <div style={{
                ...
                background: 'rgba(245,158,11,0.1)', border: '1px solid rgba(245,158,11,0.25)',
                fontSize: '0.72rem', fontFamily: "'Orbitron', sans-serif",
                color: '#FBBF24', letterSpacing: '0.1em', marginBottom: '20px',
              }}>LIVE ON ALEO TESTNET</div>
              <h2 style={{
                fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 800,
                letterSpacing: '-0.02em', marginBottom: '16px', color: '#F8FAFC',
                fontFamily: "'Orbitron', sans-serif",
              }}>
                Ready to borrow<br />without exposure?
              </h2>
              <p style={{
                color: 'rgba(148,163,184,0.8)', lineHeight: 1.7, marginBottom: '32px',
                fontSize: '0.95rem',
              }}>
                PrivLend is live on Aleo Testnet. Connect your Shield Wallet, get a credit tier, and experience DeFi the way it was always meant to work — privately.
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                { from: 'ALEO', to: 'USDCx', label: 'Collateral → Principal', color: '#6366f1', rate: '150% min ratio' },
                { from: 'USDCx', to: 'ALEO',  label: 'Repayment → Release',  color: '#10b981', rate: 'Principal + interest' },
                { from: 'ALEO', to: 'USDCx', label: 'Swap any time',         color: '#f59e0b', rate: '1:1 testnet rate' },
              ].map((pair, i) => (
                <div key={i} style={{
                  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                  padding: '14px 18px', borderRadius: '14px',
                  background: `${pair.color}08`, border: `1px solid ${pair.color}20`,
                }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, color: pair.color, fontSize: '0.9rem' }}>{pair.from}</span>
                    <span style={{ color: 'rgba(148,163,184,0.4)' }}>→</span>
                    <span style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, color: '#f1f5f9', fontSize: '0.9rem' }}>{pair.to}</span>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '0.65rem', color: 'rgba(148,163,184,0.5)', letterSpacing: '0.05em' }}>{pair.label}</div>
                    <div style={{ fontSize: '0.75rem', color: pair.color, fontFamily: "'Space Mono', monospace", fontWeight: 600 }}>{pair.rate}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <footer style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontFamily: "'Orbitron', sans-serif", fontSize: '0.85rem', color: '#475569', letterSpacing: '0.04em' }}>
              PrivLend · Built on Aleo
            </span>
          </div>
          <div style={{ display: 'flex', gap: '24px' }}>
            {[
              { label: 'Testnet Explorer', href: 'https://testnet.explorer.provable.com' },
              { label: 'Aleo Docs', href: 'https://developer.aleo.org' },
              { label: 'Shield Wallet', href: 'https://chromewebstore.google.com/detail/shield/hhddpjpacfjaakjioinajgmhlbhfchao?utm_source=hackathon&utm_medium=mainpage&utm_campaign=akindo' },
            ].map(link => (
          ...
          <div style={{ fontSize: '0.75rem', color: '#334155', fontFamily: "'Space Mono', monospace" }}>
