...
const TIER_DATA = [
  {
    ...
    ltv: "Up to 80%",
    risk: "Low",
    desc: "Best rates for top borrowers",
  },
  {
    tier: "B",
    label: "Standard",
  ...
  },
  {
    ...
    ltv: "Up to 60%",
    risk: "High",
    desc: "Higher rates, build history",
  },
];
...
const CollateralCalculator: React.FC = () => {
  ...
  const ltv =
    principal > 0 ? ((principal / minCollateral) * 100).toFixed(1) : "0";
    ...
    >
      ...
      <Grid container spacing={2} mb={3}>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <TextField
            ...
            value={durationDays}
            onChange={(e) =>
              setDurationDays(Math.max(10, Number(e.target.value)))
            }
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
      ...
      <Grid container spacing={1.5}>
        {[
          {
            label: "Principal",
            value: `${principal.toLocaleString()} USDCx`,
            color: "#F59E0B",
          },
          {
            label: "Interest",
            value: `${interest.toFixed(2)} USDCx`,
            color: "#8b5cf6",
          },
          {
            label: "Total Repayment",
            value: `${totalRepay.toFixed(2)} USDCx`,
            color: "#10b981",
          },
          {
            label: "Collateral (min)",
            value: `${minCollateral.toLocaleString()} µALEO`,
            color: "#f59e0b",
          },
      ...
      >
        <Typography variant="caption">
          Collateral ratio is fixed at <strong>150%</strong> minimum. If you
          don't repay before the deadline, your lender can liquidate your
          collateral.
        </Typography>
      </Alert>
    </Paper>
        ...
        >
          <Grid container spacing={2} alignItems="center">
            {[
              {
                label: "ALEO Balance",
                value: `${aleoBalance} ALEO`,
                color: "#f59e0b",
              },
              {
                label: "USDCx Balance",
                value: `${balances.usdcx.toString()} USDCx`,
                color: "#F59E0B",
              },
              {
                label: "Active Loans",
              ...
              <Grid size={{ xs: 6, sm: 4, md: 2 }} key={label}>
                <Box>
                  ...
                  <Typography
                    fontWeight={700}
                    sx={{ color, fontFamily: "monospace", fontSize: "0.95rem" }}
                  >
                    {value}
                  </Typography>
                </Box>
        ...
        {expiredUserLoans.length > 0 && (
          ...
          >
            <Alert
              ...
              icon={<Warning />}
            >
              You have <strong>{expiredUserLoans.length}</strong> expired
              loan(s) at risk of liquidation. Repay as soon as possible.
            </Alert>
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <Grid size={{ xs: 12, lg: 5 }}>
          <Stack spacing={3}>
            ...
            >
              ...
              >
                <Typography fontWeight={700} color="white" mb={2.5}>
                  How to Borrow
                </Typography>
                <Stack spacing={0}>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Typography
                              fontWeight={800}
                              sx={{ color: t.color, fontSize: "0.85rem" }}
                            >
                              {t.tier}
                            </Typography>
                          </Box>
                        ...
                        <Box textAlign="right">
                          <Typography
                            variant="body2"
                            fontWeight={700}
                            sx={{ color: t.color, fontFamily: "monospace" }}
                          >
                            {t.minRate}–{t.maxRate}%
                          </Typography>
        ...
        <Grid size={{ xs: 12, lg: 7 }}>
          ...
          >
            ...
            >
              ...
              >
                <Tab
                  label={`Active & Expired (${activeUserLoans.length + expiredUserLoans.length})`}
                />
