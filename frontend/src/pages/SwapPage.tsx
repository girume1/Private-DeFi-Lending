...
const StatPill: React.FC<{ label: string; value: string; color: string }> = ({
  ...
  >
    ...
    <Typography
      variant="h6"
      fontWeight={700}
      sx={{ color, fontFamily: "monospace", mt: 0.3 }}
    >
      {value}
    </Typography>
  </Box>
  ...
  if (!connected) {
    return (
      <Box textAlign="center" py={10}>
        ...
        >
          <SwapIcon
            sx={{ fontSize: 64, color: "#6366f1", mb: 2, opacity: 0.7 }}
          />
          ...
          >
            <Stack spacing={3}>
              ...
              >
                ...
                <Stack spacing={1.5}>
                  {[
                    {
                      step: "1",
                      text: "Choose direction — Credits → USDCx or vice versa",
                    },
                    { step: "2", text: "Enter amount to swap" },
                    {
                      step: "3",
                      text: "Set slippage tolerance (default 0.5%)",
                    },
                    {
                      step: "4",
                      text: "Confirm in Shield Wallet — atomic on-chain swap",
                    },
                  ].map(({ step, text }) => (
                    <Stack
                      key={step}
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary" mt={0.5}>
                  This swap uses test tokens. The 1:1 rate is for testnet
